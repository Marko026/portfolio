...
const ProjectCard = ({ project }: { project: AllProjects }) => {
  ...
  return (
    <Link
      ...
      key={project._id}
      className="relative md:w-[55%] px-10 pt-5 rounded-3xl overflow-hidden transition-transform duration-300 hover:scale-105">
        ...
        <motion.div
          ...
          <CardHeader className="!p-0">
            <Image
              ...
              height={200}
              priority={true}
              className="object-cover w-full h-full mb-5 rounded-t-3xl"
            />
            <CardTitle className="h2-normal pl-2 !w-full !mb-2 line-clamp-1 text-gray-900">
              {project.title}
            </CardTitle>
          </CardHeader>
